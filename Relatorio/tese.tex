...
\advisor{Maj.~Eng.}{Barbacovi}{FAB}

% Coorientador (Caso não haja coorientador, colocar ambas as variáveis \coadvisorgender e \coadvisor comentadas, com um % na frente)
\coadvisorgender{masc}									% masc ou fem
\coadvisor{Prof.~Dr.}{Christopher Shneider Cerqueira}{ITA}
...
\input{Secoes/Intro/organisation}
\input{Secoes/Intro/motivacao}
\input{Secoes/Intro/objetivos}
\clearpage

\chapter{Literature Review}
\label{sec:lit_review}
\input{Secoes/Revisao/arvr}
\input{Secoes/Revisao/agents}
\input{Secoes/Revisao/orbit}


\chapter{Methodology}
\label{sec:methodology}
\input{Secoes/Metodologia/cap3}
\input{Secoes/Metodologia/implementation_plan}

\input{Secoes/Resultados/cap4}

\chapter{Conclusion}
\label{chap:conclusion}
\input{Secoes/Conclusao/conclusion}
...
\input{ApeD/apendiceD}
\input{ApeE/apendiceE}
