...
\begin{itemize}
    ...
    \item \textbf{Chapter \ref{sec:methodology}: Methodology.} This chapter details the practical design, implementation, and demonstration strategy of the project.
    \begin{itemize}
        \item \textit{System Architecture and Data Flow} (\S\ref{sec:system_architecture}): Describes the end-to-end fluxogram of the system, illustrating how user voice input is captured, processed by the agent, and rendered in the virtual reality simulation in a continuous loop.
        ...
        \item \textit{Demonstration and Release Strategy} (\S\ref{sec:evaluation_plan}): Outlines the approach for showcasing the platform's capabilities through a demonstration video and releasing it as open-source software to enable community validation, adaptation, and extension.
    \end{itemize}
\end{itemize}