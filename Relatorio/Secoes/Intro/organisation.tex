...
This work is organised into four main chapters, each addressing a distinct aspect of the project. The breakdown is as follows:
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Mixed Reality Design Rationale} (\S\ref{sec:mr_rationale}): Explains the pedagogical reasoning for emphasizing immersive VR over AR passthrough for orbital mechanics education, addressing the mismatch between cosmic-scale phenomena and room-scale spatial contexts.
        ...
        \item \textit{Validation and Dissemination Strategy} (\S\ref{sec:evaluation_plan}): Outlines the approach for validating educational effectiveness through complete interaction scenarios and releasing the platform as open-source software to enable community validation and extension.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Open-Source Platform Delivery} (\S\ref{sec:open_source_delivery}): Documents the GitHub repository release, including source code organization, deployment documentation, API configuration procedures, and community validation mechanisms.
    \end{itemize}
\end{itemize}
