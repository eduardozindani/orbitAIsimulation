...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Technical Implementation} (\S\ref{sec:core_components}): Summarizes the integration of conversational AI (OpenAI GPT-4, ElevenLabs voice synthesis), Unity 3D physics simulation, and Meta Quest 3 deployment with character-driven specialist personas.
