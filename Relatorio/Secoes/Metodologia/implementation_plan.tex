...
\begin{enumerate}
    ...
    \item User physically rotates globe (if on turntable) or walks to opposite side to see orbit's ground track.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Physical interface (embodied interaction):} Sprint 5 anchors virtual orbital visualizations to a physical globe in augmented reality, creating a tangible reference point for spatial understanding.
    \item \textbf{Multimodal interaction:} Sprints 3 (voice), 4 (VR controllers/hand tracking), and 5 (AR physical space) combine spoken dialogue, gestural input, and spatial manipulation for seamless interaction.
