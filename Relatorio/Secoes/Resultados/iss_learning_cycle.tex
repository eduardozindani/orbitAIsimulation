...
\begin{itemize}
    ...
    \item \textbf{Voice Pipeline}: Multiple bidirectional conversations → character switching (CAPCOM $\leftrightarrow$ ANASTASIA) → response latency under 7 seconds
    \item \textbf{VR Environment}: Scene transitions (Hub $\leftrightarrow$ ISS) → spatial observation → 90 Hz rendering maintained throughout
\end{itemize}
